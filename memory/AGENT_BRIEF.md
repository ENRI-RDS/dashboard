...
_Ultimo aggiornamento: 2026-07-03 (rev. 80) — rev.80: `scavi.html` — card "Avanzamento per Cluster": nome imprese 9px→12px (illeggibile, feedback utente), "X lotti" sostituita con l'elenco reale degli id lotto del cluster sotto le imprese (v. §4.39.h).
