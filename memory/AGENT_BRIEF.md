...
| 11.1 | Index | Eliminare previsione "mia" e richiederla all'impresa | In corso (rev.46) | Alta | `index.html`+`Master.csv`+`server.py`(verificato ok)+`imprese.html` fatti — manca solo `mappa_impresa_caricamento.html` (da verificare se pertinente) |
