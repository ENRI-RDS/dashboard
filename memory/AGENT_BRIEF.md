...
_Versione compattata il 2026-07-06: changelog rev.65-113 compattato in riassunto tematico (rev.10-64 già in `AGENT_BRIEF_ARCHIVE.md` da compattazione precedente), 671→~624 righe. Restano inline solo rev.114-136 (dettagliate, più recenti/actionable). Tabella TODO §11: chiuse 2 voci verificate (export GeoJSON imprese, verifica pendente rev.129/130)._
